# Analyse-Avancee
Cours B3 - Analyse de données avancée

- [Prérequis](https://github.com/Jehadel/Analyse-Avancee/blob/main/TP_0_installation_prerequis-FINAL.md) : setup, (WSL pour Windows), installation de Docker, environnement virtuel, éditeur de texte. **À faire impérativement en premier, avant toute autre activité** 
Ressource complémentaire : [requirements.txt](https://github.com/Jehadel/Analyse-Avancee/blob/main/requirements.txt)
